...
Purpose: train and test a neural net work for image classification
"""
...
def load_images(in_path):
    """
    load images from a folder and flatten them into tensors
    ...
    for i, dir in enumerate(img_dirs):
        ...
        # go through all the images for one class
